...
//    делаем синглтон для доступа к данным класса
    ...
    var names = ["Vladimir","Aleksander","Sergei","Dmitriy","Petr","Mikhail","Igor","Aleksei"," Ivan","Victor","Konstantin"].shuffled()
    var surnames = ["Medvedev", "Yeremin", "Putin", "Hasymov", "Zhirnov", "Bravy", "Shalyapin", "Kukushkin", "Raykin", "Rodnoy", "Pushkin"].shuffled()
